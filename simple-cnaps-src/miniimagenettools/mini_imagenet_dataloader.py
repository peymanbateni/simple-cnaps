...
class MiniImageNetDataLoader(object):
    def __init__(self, shot_num, way_num, episode_test_sample_num, shuffle_images = False):
        ...
        metatrain_folder = './miniimagenettools/processed_images/train'
        metaval_folder = './miniimagenettools/processed_images/val'
        metatest_folder = './miniimagenettools/processed_images/test'

        npy_dir = './mini_episode_filename_list/'
