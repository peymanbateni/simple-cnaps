...
#SBATCH --mem=60G
#SBATCH --nodes=1
#SBATCH --job-name=simple_cnaps_continual_learning
...
alias run_continual_mnist="python -u run_continual_learning.py --dataset MNIST --test_shot 1000 --test_epochs 30 --model $MODEL"
alias run_continual_cifar10="python -u run_continual_learning.py --dataset CIFAR10 --test_shot 1000 --test_epochs 30 --CIFAR_resize on --model $MODEL"
alias run_continual_cifar100="python -u run_continual_learning.py --dataset CIFAR100 --test_shot 1000 --test_epochs 30 --CIFAR_resize on --model $MODEL"
