...
#SBATCH --mem=60G
#SBATCH --nodes=1
#SBATCH --job-name=transductive_cnaps_continual_learning_moving
...
STRATEGY="moving-encoding"

conda deactivate
deactivate
source /ubc/cs/research/plai-scratch/peyman/new_cnaps_results/simple-cnaps-tests/simple-meta-dataset/new-env/bin/activate

alias run_continual_mnist="python -u run_continual_learning.py --dataset MNIST --test_model_path  $TESTMODEL --test_shot 1000 --test_epochs 30 --model $MODEL --continual_learning_strategy $STRATEGY"
alias run_continual_cifar10="python -u run_continual_learning.py --dataset CIFAR10 --test_model_path  $TESTMODEL --test_shot 1000 --test_epochs 30 --CIFAR_resize on --model $MODEL --continual_learning_strategy $STRATEGY"
alias run_continual_cifar100="python -u run_continual_learning.py --dataset CIFAR100 --test_model_path  $TESTMODEL --test_shot 1000 --test_epochs 30 --CIFAR_resize on --model $MODEL --continual_learning_strategy $STRATEGY"
