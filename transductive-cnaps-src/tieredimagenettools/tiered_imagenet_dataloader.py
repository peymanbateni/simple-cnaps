...
class TieredImageNetDataLoader(object):
    def __init__(self, shot_num, way_num, episode_test_sample_num):
        ...
        metatrain_folder = './tieredimagenettools/tiered_imagenet/train'
        metaval_folder = './tieredimagenettools/tiered_imagenet/val'
        metatest_folder = './tieredimagenettools/tiered_imagenet/test'

        npy_dir = './tiered_episode_filename_list/'
