...
#SBATCH --mem=50G
#SBATCH --nodes=1
#SBATCH --job-name=simple_cnaps_active_learning_cifar10_all_algos
...
python3 -u run_active_learning.py \
        ...
        --model simple_cnaps \
        --dataset cifar10 --test_model_path ../model-checkpoints/meta-dataset-checkpoints/best_simple_cnaps.pt \
