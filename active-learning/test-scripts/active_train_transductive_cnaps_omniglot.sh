...
#SBATCH --mem=50G
#SBATCH --nodes=1
#SBATCH --job-name=transductive_cnaps_active_learning_omniglot_all_algos
...
python3 -u run_active_learning.py \
        ...
        --dataset omniglot --language all --test_model_path ../model-checkpoints/meta-dataset-checkpoints/best_transductive_cnaps.pt --active_learning_method predictive_entropy
...
python3 -u run_active_learning.py \
        ...
        --checkpoint_dir ../checkpoints/${SLURM_JOB_ID} \
        --model transductive_cnaps \
        --dataset omniglot --language all --test_model_path ../model-checkpoints/meta-dataset-checkpoints/best_transductive_cnaps.pt --active_learning_method var_ratios
...
python3 -u run_active_learning.py \
        ...
        --checkpoint_dir ../checkpoints/${SLURM_JOB_ID} \
        --model transductive_cnaps \
        --dataset omniglot --language all --test_model_path ../model-checkpoints/meta-dataset-checkpoints/best_transductive_cnaps.pt --active_learning_method random
